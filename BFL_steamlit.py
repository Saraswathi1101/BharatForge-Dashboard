...
iframe_code = f'''
<div style="background-color: white; width: 1390px; box-sizing: border-box; margin-left: -300px; margin-top: -90px; padding: 20px;">
    <div style="background-color: white;">
        <iframe width="100%" height="800" src="{powerbi_url}" frameborder="0" allowFullScreen="true" style="margin-top: 55px;"></iframe>
    </div>
</div>
'''
